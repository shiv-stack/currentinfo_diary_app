...
class DatesheetPage extends StatefulWidget {
  ...
  const DatesheetPage({super.key, required this.student});
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text(
                      notice['time']?.toString().toUpperCase() ?? 'EXAM SCHEDULE',
                      style: TextStyle(
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Icon(Icons.assignment_rounded, size: 70, color: Colors.grey.shade300),
          ),
          const SizedBox(height: 30),
          const Text("No Datesheet Found", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w900, color: Color(0xFF1A1C1E), letterSpacing: -0.5)),
        ],
      ),
    );
  }
